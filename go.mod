...
replace github.com/dressc-go/decryptorservice/pkg/config => github.com/dressc-go/decryptorservice/pkg/config v0.0.0-20231004152134-271c0b9b389e

replace github.com/dressc-go/decryptorservice/pkg/server => github.com/dressc-go/decryptorservice/pkg/server v0.0.0-20231004152134-271c0b9b389e
